...
import CoordinateDTO from "../types/CoordinateDTO.type";
...
export default function MapField(props: MapFieldProps) {
    ...
    return (
        <div style={{ height: "400px" }} className="mt-4">
            <MapContainer center={[props.coordinates.latitude, props.coordinates.longitude]} zoom={14} style={{ height: "100%", width: "100%" }}>
